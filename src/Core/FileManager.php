...
class FileManager {
	...
	public function includeTemplate( $__template, array $__variables = array() ) {
		...
		if ( $__template ) {
			...
			do_action( 'custom_price_display/template/before_render', $__template, $__variables );
			// nosemgrep: audit.php.lang.security.file.inclusion-arg
			include( $__template );
			do_action( 'custom_price_display/template/after_render', $__template, $__variables );
		}
	}
	...
	public function locateTemplate( $template ) {
		...
		return apply_filters( 'custom_price_display/template/location', $file, $template );
	}
